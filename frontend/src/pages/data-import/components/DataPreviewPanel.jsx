...
/**
 * Componente de Preview dos Dados Importados
 * 
 * Exibe uma prévia dos dados do arquivo importado, incluindo estatísticas,
    ...
    <div className="space-y-6">
      ...
      <div className="bg-surface rounded-lg border border-border p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-background rounded-lg p-4 border border-border">
            <div className="flex items-center gap-3">
              <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                successRate >= 95 ? 'bg-success/10' : successRate >= 80 ? 'bg-warning/10' : 'bg-error/10'
              }`}>
            ...
            <div className="flex items-center gap-2 p-3 bg-warning/10 border border-warning/20 rounded-lg">
              ...
              <div>
                <p className="text-sm font-medium text-warning">
                  Atenção: {errorRows} registro(s) com problemas
                </p>
      ...
      <div className="flex items-center justify-end gap-4">
        <div className="text-sm text-text-secondary">
          {validRows.toLocaleString('pt-BR')} registros serão processados
        </div>
