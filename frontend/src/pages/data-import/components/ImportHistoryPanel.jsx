...
/**
 * Componente de Histórico de Importações
 * 
 * Exibe o histórico de importações realizadas para o cliente selecionado,
 * incluindo filtros, busca e ações como retry e download de logs.
 * 
 * @param {Array} imports - Lista de importações
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-text-secondary">
              {filteredImports.length} de {imports.length} importação(ões)
            </p>
          </div>
        </div>
        ...
        {currentImports.length > 0 ? (
                    ...
                    <div className="flex items-center gap-6 mt-3 text-sm">
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-text-secondary">
                          {importItem.recordsProcessed?.toLocaleString('pt-BR') || 0} processados
                        </span>
                      </div>
          ...
          <div className="p-12 text-center">
            ...
            <h3 className="text-lg font-medium text-text-secondary mb-2">
              {searchTerm || statusFilter !== 'all' ? 'Nenhuma importação encontrada' : 'Nenhuma importação realizada'}
            </h3>
