  ...
  const reportCategories = [
    {
      ...
      reports: [
        ...
        },
        {
          ...
          description: 'Visão geral de ativos, passivos e patrimônio',
      ...
      reports: [
        {
          ...
          description: 'Relatório de verificação de saldos das contas',
        ...
        },
        {
          ...
          description: 'Comparação de performance orçado vs realizado',
        ...
        {
          id: 'aging-report',
          name: 'Relatório de Aging',
          description: 'Aging de contas a receber e a pagar',
      ...
      reports: [
        {
          ...
          description: 'Resumo de impostos sobre bens e serviços',
        ...
        },
        {
          ...
          description: 'Obrigações fiscais atuais e pagamentos',
        ...
        <div className="p-6">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h1 className="text-3xl font-heading font-bold text-text-primary">Relatórios Financeiros</h1>
                <p className="text-text-secondary mt-1">
                  Gere demonstrações financeiras abrangentes e relatórios gerenciais
                </p>
              </div>
              ...
              {selectedReport ? (
                ...
                <div className="bg-surface rounded-lg border border-border p-12 text-center">
                  ...
                  <p className="text-text-secondary">
                    Escolha um relatório das categorias à esquerda para visualizar dados financeiros detalhados
                  </p>
                </div>
              )}
            </div>
